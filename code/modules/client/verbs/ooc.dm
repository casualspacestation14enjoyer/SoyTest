...
/client/verb/ooc(msg as text)
	...
	if(check_whitelist(keyname))
		keyname = "<font color='[prefs.ooccolor ? prefs.ooccolor : GLOB.normal_ooc_colour]'>[icon2html('icons/member_content.dmi', world, "blag")]Chud</font>"
	if(prefs.custom_ooc)
